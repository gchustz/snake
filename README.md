...
# State of the Paper
Paper is writtten in markdown, which I find easier to draft in then LaTeX. As a result, the citations are not yet incorporated correctly.
